...
<main class="uploadContainer">
	...
	<section class="upload">
		...
		<!--사진업데이트 Form #profileUpdate  onsubmit="update2(${image.id}, event)"  onsubmit="/image/update"-->
		...
		<input type="hidden" id="id" value="${image.id}"/>
			...
			<div>
				...
				<div class="upload-form-detail">
					...
					id="postImageUrl" value="${image.postImageUrl}"/>
				...
				<div class="upload-form-detail">
					<div class="border-group">
						...
						<div class="form-group row">
							...
							<div class="col-sm-5">
								<input type="text" placeholder="레시피 제목" name="title" id="title"
									class="input" value="${image.title}">
							</div>
						</div>
						...
						<div class="form-group row">
							...
							<div class="col-sm-5">
								<input type="text" placeholder="요리소개를 간단하게 적어주세요"
									name="subTitle" id="subTitle" class="input " value="${image.subTitle}">
							</div>
						</div>
						...
						<div class="form-group row">
							...
							<div class="col-sm-7">
								<input type="text" class="input" placeholder="사용한 재료 작성"
									name="ingredient" id="ingredient" value="${image.ingredient}"/>
							</div>
						</div>
						...
						<div class="form-group row">
							...
							<textarea name="cookTip" form="myForm" cols="30" rows="5" id="cookTip"
								placeholder="Ex) 고기요리에는 소금보다 설탕을 넣어야 단맛이 겉돌지 않고 육질이 부드러워요">
								${image.cookTip}</textarea>
						</div>
					...
					<div class="form-group row">
						<div class="col-sm-7">
							...
							<textarea name="cation01" form="myForm" cols="30" rows="5"
								id="cation01"placeholder="요리과정에 대해 설명해 주세요" style="width: 550px;">${image1.cation01}</textarea>
						</div>
						<div class="col-sm-3">
							<input type="file" name="file2" onchange="imageChoose2(this)" value="${image1.postImageUrl01}"/>
					...
					<div class="form-group row">
						<div class="col-sm-7">
							...
							<textarea name="cation02" form="myForm" cols="30" rows="5"
								placeholder="요리과정에 대해 설명해 주세요" style="width: 550px;">${image1.cation02}</textarea>
						</div>
						<div class="col-sm-3">
					...
					<div class="form-group row">
						<div class="col-sm-7">
							...
							<textarea name="cation03" form="myForm" cols="30" rows="5"
								placeholder="요리과정에 대해 설명해 주세요" style="width: 550px;">${image1.cation03}</textarea>
						</div>
						<div class="col-sm-3">
					...
					<div class="form-group row">
						<div class="col-sm-7">
							...
							<textarea name="cation04" form="myForm" cols="30" rows="5"
								placeholder="요리과정에 대해 설명해 주세요" style="width: 550px;">${image1.cation04}</textarea>
						</div>
						<div class="col-sm-3">
					...
					<div class="form-group row">
						<div class="col-sm-7">
							...
							<textarea name="cation05" form="myForm" cols="30" rows="5"
								placeholder="요리과정에 대해 설명해 주세요" style="width: 550px;">${image1.cation05}</textarea>
						</div>
						<div class="col-sm-3">
			...
			<button class="cta blue button" id="btn-update">수정완료</button>
